...
public class _19236 {
	...
	public static void fishMove(int fishNumber, Shark shark) {
		...
		if (cur_fish_dir == 0) {
			...
			// 반시계 방향으로 45도씩 돌아간다.
			// ↑, ↖, ←, ↙, ↓, ↘, →, ↗ 순서가 이럲다.
			System.out.println("fishNumber : " + fishNumber + "  cur_fish_dir : " + cur_fish_dir);
			System.out.println("cur_fish_y : " + cur_fish_y + "  cur_fish_x : " + cur_fish_x);
